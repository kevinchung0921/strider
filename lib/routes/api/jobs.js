...
exports.jobs_start = function(req, res) {
  var type = req.body.type || TEST_ONLY
    ...
    // obtain gerrit information
    var changeNum = req.body.changeUrl;
    var patchset = req.body.patchset;
    var change = req.body.change;
    var commit = req.body.commit;
    var gerrit_project = req.body.project;
    if(changeNum) {
        var pathes = changeNum.split('/');
        changeNum = pathes[pathes.length-1];
    }
